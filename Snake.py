...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("The more apples you eat , the longer you geet" , black , 10)
        message_to_screen("If you run into yourself , or the edges you die!" , black ,50)
        message_to_screen("Press C to Play , P to pause or Q for Quit" , black ,180)
        pygame.display.update()
        clock.tick(15)
...
def gameLoop():
    ...
    while not gameExit:
        while gameOver== True:
            ...
            message_to_screen("c for play again or q for quit", black,50, size="medium")
            pygame.display.update()
